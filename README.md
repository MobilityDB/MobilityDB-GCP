...
This work has been developed as part of a my master's thesis in computer science. A detailed report can be found here![alt text](./docs/report/MobilityDB-GCP-Report.pdf).
## Get Started
